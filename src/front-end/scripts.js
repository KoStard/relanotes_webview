...
define("tools", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("app", ["require", "exports", "tools"], function (require, exports, tools_1) {
    "use strict";
    exports.__esModule = true;
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            _a = tools_1.get_waiter(), f = _a[0], p = _a[1];
                            this.requests[id.toString()] = { f: f, p: p };
                            window.external.invoke(JSON.stringify(request));
